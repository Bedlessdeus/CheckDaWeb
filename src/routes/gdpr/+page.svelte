...
<div class="container mx-auto p-4 sm:p-8 md:p-10 lg:p-12">
	...
	>
		<h1 class="mb-6 text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">
			Privacy Policy
		</h1>
		...
		<div class="prose max-w-none">
			...
			<p class="mb-4 text-gray-700 dark:text-gray-300">
				...
				transparent manner. This policy is in compliance with the General Data Protection Regulation
				(GDPR) (EU) 2016/679.
			</p>
			...
			<p class="mb-4 text-gray-700 dark:text-gray-300">
				Given our no-log policy, we do not use your information for any purposes such as analytics,
				marketing, or personalization, as we do not collect such data.
			</p>
			...
			<p class="mb-4 text-gray-700 dark:text-gray-300">
				As we do not collect personal data under our no-log policy, there is no personal data to
				share or disclose with third parties.
			</p>
			...
			<p class="mb-4 text-gray-700 dark:text-gray-300">
				Under the GDPR, you have the following rights concerning your personal data. While our
				no-log policy minimizes the personal data we hold, these rights still apply if any personal
				data were to be processed by us (e.g., if you contact us directly and provide information):
			</p>
